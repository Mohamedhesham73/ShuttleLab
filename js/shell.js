...
export function header(){
  const tabs = state.role==="coach"
    ? [["team","Team"],["train","Training"],["library","Library"],["matches","Matches"],["board","Leaderboard"],["mind","Mind Room"]]
    : [["dash","Dashboard"],["log","Log"],["train","Training"],["library","Library"],["matches","Videos"],["board","Leaderboard"],["mind","Mind Room"]];
